...
ufp %>%
  ...
  labs(y="UFP adjustment after winsorization",
       x= "covariate value",
       col="Prediction",
       title = "covariates & winsorization"
       )
...
ggsave(file.path("output", "summary", paste0("covariates_vs_winsorization_predictions_reduced.png")), width = 16, height = 10)
...
ggsave(file.path("output", "summary", paste0("covariate_density1.png")), width = 12, height = 10)
#ggsave(file.path("output", "summary", paste0("covariates_histograms2.png")), width = 12, height = 10)
#ggsave(file.path("output", "summary", paste0("covariate_barplot.png")), width = 12, height = 10)
