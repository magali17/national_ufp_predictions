...
#ggsave(file.path(output_path, paste0("covariates_histograms2.png")), width = 12, height = 10)
#ggsave(file.path(output_path, paste0("covariate_barplot.png")), width = 12, height = 10)
