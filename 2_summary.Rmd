...
if(testing_mode==TRUE){
  ufp_2010 <- slice_sample(ufp_2010, n = 1e2)
  }
...
ufp_2010 %>%
  ...
  mutate(winsorized = ifelse(ufp_winsorized<ufp_original, "prediction reduced",
                                   ifelse(ufp_winsorized>ufp_original, "prediction increased", "not changed")
                                   )) %>%
  st_as_sf(coords = c('long_block', 'lat_block'), crs=project_crs) %>%
